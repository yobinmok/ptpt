package com.ssafy.ptpt.api.security.model.response;
...
public class TokenResponseBody extends BaseResponseBody {
    ...
    public static TokenResponseBody of(Integer statusCode, String message, String accessToken, String memberId) {
